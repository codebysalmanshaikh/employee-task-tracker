...
const TasklistNumbers = ({data}) => {
  return (
    <div className='flex mt-10 justify-between gap-5 screen text-[#FFFFFF] '>
        <div className=' w-[45%] rounded-xl py-6 px-10 text-[#FFFFFF] bg-blue-400 border-2 border-[#2FA4FF]'>
            <h2 className='text-2xl font-semibold'>{data.taskCounts.newTask}</h2>
            <h3 className='text-xl font-medium'>New Task</h3>
        </div>

        <div className=' w-[45%] rounded-xl py-6 px-10 text-[#FFFFFF] bg-blue-400'>
